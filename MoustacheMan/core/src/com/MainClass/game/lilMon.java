...
public class lilMon extends Enemy {
    ...
    protected void defineEnemy() {
        ...
        veritice[0] = new Vector2(-20, 35).scl(1 /MainClass.PPM);
        veritice[1] = new Vector2(20, 35).scl(1 /MainClass.PPM);
        veritice[2] = new Vector2(-8, 30).scl(1 /MainClass.PPM);
        veritice[3] = new Vector2(8, 30).scl(1 /MainClass.PPM);
        head.set(veritice);
        fdef.isSensor = true;
